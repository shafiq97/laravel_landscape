    ...
    <div id="homepage">
        <section id="landing" class="background section">
            <div class="content-wrapper bgpaper centered">
                <div class="logo">
                    <img src="https://img.freepik.com/premium-vector/mountain-green-field-alpine-landscape-nature-with-wooden-houses_194708-1779.jpg" alt="">
                    ...
                    <h1 id="title">Lanscaper 4 You</h1>
                </div>
            </div>
        </section>
