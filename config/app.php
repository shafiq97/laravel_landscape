...
return [
    ...
    */
    ...
    'features' => [
        'registration' => (bool) env('REGISTRATION_ENABLED', false),
    ],
    ...
    */
    ...
    'urls' => [
        'legal_notice' => env('APP_URL_LEGAL_NOTICE'),
        'privacy_statement' => env('APP_URL_PRIVACY_STATEMENT'),
